            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between px-1">
                        ...
                        <div className="px-2.5 py-1 rounded bg-info-light text-info text-[10px] font-bold tracking-wide uppercase">
                            Reference
                        </div>
                    </div>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between px-1">
                        ...
                        <div className="px-2 py-1 rounded bg-gain-light text-gain flex items-center gap-1.5 text-[10px] font-bold tracking-wide uppercase">
